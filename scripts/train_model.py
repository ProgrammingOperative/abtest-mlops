...
X_train = pd.read_csv((Config.FEATURES_PATH / "train_features.csv").resolve())
y_train = pd.read_csv((Config.FEATURES_PATH / "train_labels.csv").resolve())
...
class TrainModel:
    ...
    def train_model(self):
        best_model = None
        best_param = None
        avg_metrics = dict(accuracy=0, r_squared=0, rmse=0, mae=0)
